...
import { getGames } from "@/lib/services";
...
export default function HomePage() {
  ...
  useEffect(() => {
    getGames().then((all) => setGames(all.slice(0, 6)));
  }, []);
          ...
          <div className="activity-card">
            ...
            <div className="top-list">
              {TOP_PLAYERS.map((r, i) => (
                <div
                  key={i}
                  className={"top-row" + (i < 3 ? " " + RANK_CLASS[i] : "")}
                >
          ...
          <div className="pricing-faq">
            <div className="faq-item">
              ...
              <div className="faq-a">
                ...
                No hay versión &ldquo;premium&rdquo; escondida.
              </div>
            </div>
            <div className="faq-item">
